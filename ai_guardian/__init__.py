"""ai-guardian — governed observability + governance for on-endpoint local LLMs.

Observes and audits local LLM (Ollama) usage — the complement to IGEL AI Armor.
...
try:
    __version__ = version("ai-guardian-aiops")
